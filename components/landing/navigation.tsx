        ...
        >
          ...
          <a href="#" className="flex items-center gap-2 group">
            <Image
              ...
              width={36}
              height={36}
              className={`object-contain transition-all duration-500 ${isScrolled ? "w-7 h-7" : "w-9 h-9"}`}
            />
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Button
              size="sm"
              className={`cursor-pointer bg-foreground hover:bg-foreground/90 text-background rounded-full transition-all duration-500 ${isScrolled ? "px-4 h-8 text-xs" : "px-6"}`}
